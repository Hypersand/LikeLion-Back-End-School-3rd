...
public class Problem34_2 {
    ...
    public static class 고무2오리 extends 오리 {
        고무2오리() {
            a비행아이템 = new 날수없는아이템();
        }
    ...
    public static abstract class 비행아이템 {
        void 동작() {
        }
    }

    public static class 날수있는아이템 extends 비행아이템{
        void 동작() {
            System.out.println("오리가 날개로 날아갑니다");
        }
    }

    public static class 날수없는아이템 extends 비행아이템 {
        void 동작() {
